            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Tambah Data Manajer</h4>
                    </div>
                </div>
                <header>
                    <div class="row">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="profile-upload">
                                                ...
                                                <div class="upload-input">
                                                    <input type="file" class="form-control" name="foto_manajer" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="id_manajer" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Nama Manajer <span class="text-danger">*</span></label>
                                            <input type="text" name="nama_manajer" class="form-control" required>
                                        </div>
                                    </div>
                                </div>

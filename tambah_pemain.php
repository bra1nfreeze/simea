            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="manager.php"><i class="fa fa-user-md"></i> <span>Manager</span></a>
                        </li>
                        <li>
                            <a href="team.php"><i class="fa fa-wheelchair"></i> <span>Team</span></a>
                        </li>
                        <li>
                            <a href="penghargaan.php"><i class="fa fa-medkit"></i> <span>Penghargaan</span></a>
                        </li>
                        <li class="active">
                            <a href="player.php"><i class="fa fa-medkit"></i> <span>Player</span></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Tambah Data Pemain</h4>
                    </div>
                </div>
                <header>
                    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>NPM Pemain <span class="text-danger">*</span></label>
                                            <input class="form-control" type="text" name="id_pemain" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>ID Team <span class="text-danger">*</span></label>
                                            <select class="select" name="id_tim" required>
                                                <option>Select
                                                <option>
                                                    <?php
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="select" name="id_penghargaan" required>
                                                <option>Select
                                                <option>
                                                    <?php
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="nama_pemain" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="select" name="jurusan" required>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="select" name="nama_penghargaan" required>
                                                <option>Select
                                                <option>
                                                    <?php
                                                    $sql = "SELECT nama_penghargaan FROM penghargaan";
                                                    $query = mysqli_query($conn, $sql);
                                                    while ($data = mysqli_fetch_assoc($query)) {
                                                        echo '<option value="' . $data['nama_penghargaan'] . '">' . $data['nama_penghargaan'] . '</option>';
                                                    }

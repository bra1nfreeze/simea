...
$mts = tampil("SELECT * FROM penghargaan WHERE id_penghargaan = '$id_penghargaan'")[0];

//proses edit data
if (isset($_POST['simpan'])) {
    if (edit_penghargaan($_POST) > 0) {
        echo "<script>
            setTimeout(function(){
                Swal.fire({
                    icon: 'success',
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Perbarui Data Penghargaan</h4>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="" method="post">
                            <div class="row">
                                <input type="hidden" name="id_penghargaan" value="<?= $mts['id_penghargaan']; ?>">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Nama Penghargaan <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="nama_penghargaan" value="<?= $mts['nama_penghargaan']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Pendapatan (Rp) <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="pendapatan" value="<?= $mts['pendapatan']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="date" name="tgl_ach" class="form-control" value="<?= $mts['tgl_ach']; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>

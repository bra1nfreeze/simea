...
//membuat id otomatis
$query = "SELECT max(id_tim) as id_tim From team";
$hasil = mysqli_query($conn, $query);
$data = mysqli_fetch_array($hasil);
$id_tim = $data['id_tim'];
$auto_id = (int) substr($id_tim, 3, 5);
$auto_id++;
$char = "TIM";
$id_tim = $char . sprintf("%03s", $auto_id);

//proses submit data
if (isset($_POST['submit'])) {
    if (tambah_tim($_POST) > 0) {
        echo "<script>
                setTimeout(function(){
                    Swal.fire({
                        icon: 'success',
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Tambah Data Team</h4>
                    </div>
                </div>
                <header>
                    <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="select" name="id_manajer" required>
                                                <option>Select
                                                <option>
                                                    <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="profile-upload">
                                                ...
                                                <div class="upload-input">
                                                    <input type="file" class="form-control" name="foto_tim" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

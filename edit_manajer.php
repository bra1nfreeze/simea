...
$mts = tampil("SELECT * FROM manager WHERE id_manajer = '$id_manajer'")[0];
//proses edit data
if (isset($_POST['simpan'])) {
    if (edit_manajer($_POST) > 0) {
        echo "<script>
            setTimeout(function(){
                Swal.fire({
                    icon: 'success',
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Edit Manajer</h4>
                    </div>
                </div>
                <header>
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="profile-upload">
                                                ...
                                                <div class="upload-input">
                                                    <input type="file" class="form-control" name="foto_manajer" value="<?= $mts['foto_manajer']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>NPM Manajer <span class="text-danger">*</span></label>
                                            <input class="form-control" type="text" name="id_manajer" value="<?= $mts['id_manajer']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Nama Manajer <span class="text-danger">*</span></label>
                                            <input type="text" name="nama_manajer" class="form-control" value="<?= $mts['nama_manajer']; ?>">
                                        </div>
                                    </div>
                                </div>
